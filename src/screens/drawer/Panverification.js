    ...
    <View style={styles.container}>
      ...
      <Formik
        ...
        {props => (
          <View>
            <View
              style={[styles.action, {borderWidth: 0, marginTop: 10}]}
              onFocus={() => {
            ...
            <View
              ...
              onFocus={() => {
                setfirstname('First name as on PAN card');
              }}>
              <View style={styles.labelContainer}>
                <Text
                  style={{
            ...
            <View
              style={styles.action}
              onFocus={() => {
                setlastname('Last name as on PAN card');
              }}>
              <View style={styles.labelContainer}>
                <Text
                  style={{
